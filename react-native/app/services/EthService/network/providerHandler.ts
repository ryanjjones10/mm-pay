...
export class ProviderHandler {
  ...
  public async estimateGas(transaction: Partial<ITxObject>): Promise<string> {
    ...
    return this.injectClient((client) =>
      client.estimateGas(tx).then((data) => data.toString()),
    )
  }
  ...
  public getLatestBlockNumber(): Promise<string> {
    return this.injectClient((client) =>
      client.getBlockNumber().then((data) => data.toString()),
    )
  }
  ...
  public sendRawTx(signedTx: string | ITxSigned): Promise<TransactionResponse> {
    return this.injectClient((client) =>
      client.sendTransaction(signedTx as string),
    )
  }
  ...
  public waitForTransaction(
    ...
    return this.injectClient((client) =>
      client.waitForTransaction(txHash, confirmations),
    )
  }
  ...
  public getTokenAllowance(
    ...
    return this.injectClient((client) =>
      client
        .call({
          to: tokenAddress,
          data: ERC20.allowance.encodeInput({
            _owner: ownerAddress,
  ...
  public async isValidEIP1271Signature({
    address,
    msg,
    sig,
  }: ISignedMessage): Promise<boolean> {
    return this.injectClient(async (client) => {
      try {
  ...
  public getFeeHistory(
    ...
    return this.injectClient((client) =>
      (client as FallbackProvider).providers[0].perform('eth_feeHistory', [
        blockCount,
        newestBlock,
        rewardPercentiles ?? [],
      ]),
  ...
  protected injectClient(
    clientInjectCb: (client: FallbackProvider | BaseProvider) => any,
  ) {
    if (clientInjectCb) {
