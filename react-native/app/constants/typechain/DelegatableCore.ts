...
export interface DelegatableCoreInterface extends utils.Interface {
  contractName: 'DelegatableCore'
  functions: {
...
export interface DelegatableCore extends BaseContract {
  contractName: 'DelegatableCore'
  connect(signerOrProvider: Signer | Provider | string): this
  attach(addressOrName: string): this
  deployed(): Promise<this>

  interface: DelegatableCoreInterface
