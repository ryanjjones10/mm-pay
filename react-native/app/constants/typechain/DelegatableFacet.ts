...
export interface DelegatableFacetInterface extends utils.Interface {
  contractName: 'DelegatableFacet'
  functions: {
    ...
    'setDomainHash(string,string)': FunctionFragment
...
export interface DelegatableFacet extends BaseContract {
  contractName: 'DelegatableFacet'
  connect(signerOrProvider: Signer | Provider | string): this
  attach(addressOrName: string): this
  deployed(): Promise<this>

  interface: DelegatableFacetInterface
