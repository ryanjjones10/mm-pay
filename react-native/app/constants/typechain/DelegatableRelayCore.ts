...
export interface DelegatableRelayCoreInterface extends utils.Interface {
  contractName: 'DelegatableRelayCore'
  functions: {
    ...
    'verifyDelegationSignature(((address,bytes32,(address,bytes)[],uint256),bytes,address))': FunctionFragment
...
export interface DelegatableRelayCore extends BaseContract {
  contractName: 'DelegatableRelayCore'
  connect(signerOrProvider: Signer | Provider | string): this
  attach(addressOrName: string): this
  deployed(): Promise<this>

  interface: DelegatableRelayCoreInterface
