...
export interface TimestampEnforcerInterface extends utils.Interface {
  contractName: 'TimestampEnforcer'
  functions: {
...
export interface TimestampEnforcer extends BaseContract {
  contractName: 'TimestampEnforcer'
  connect(signerOrProvider: Signer | Provider | string): this
  attach(addressOrName: string): this
  deployed(): Promise<this>

  interface: TimestampEnforcerInterface
