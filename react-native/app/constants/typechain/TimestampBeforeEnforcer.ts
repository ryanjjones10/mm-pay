...
export interface TimestampBeforeEnforcerInterface extends utils.Interface {
  contractName: 'TimestampBeforeEnforcer'
  functions: {
...
export interface TimestampBeforeEnforcer extends BaseContract {
  contractName: 'TimestampBeforeEnforcer'
  connect(signerOrProvider: Signer | Provider | string): this
  attach(addressOrName: string): this
  deployed(): Promise<this>

  interface: TimestampBeforeEnforcerInterface
