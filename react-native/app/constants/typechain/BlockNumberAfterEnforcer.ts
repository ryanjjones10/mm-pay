...
export interface BlockNumberAfterEnforcerInterface extends utils.Interface {
  contractName: 'BlockNumberAfterEnforcer'
  functions: {
...
export interface BlockNumberAfterEnforcer extends BaseContract {
  contractName: 'BlockNumberAfterEnforcer'
  connect(signerOrProvider: Signer | Provider | string): this
  attach(addressOrName: string): this
  deployed(): Promise<this>

  interface: BlockNumberAfterEnforcerInterface
