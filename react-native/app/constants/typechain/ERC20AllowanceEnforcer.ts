...
export interface ERC20AllowanceEnforcerInterface extends utils.Interface {
  contractName: 'ERC20AllowanceEnforcer'
  functions: {
...
export interface ERC20AllowanceEnforcer extends BaseContract {
  contractName: 'ERC20AllowanceEnforcer'
  connect(signerOrProvider: Signer | Provider | string): this
  attach(addressOrName: string): this
  deployed(): Promise<this>

  interface: ERC20AllowanceEnforcerInterface
