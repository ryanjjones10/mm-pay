...
export interface TimestampAfterEnforcerInterface extends utils.Interface {
  contractName: 'TimestampAfterEnforcer'
  functions: {
...
export interface TimestampAfterEnforcer extends BaseContract {
  contractName: 'TimestampAfterEnforcer'
  connect(signerOrProvider: Signer | Provider | string): this
  attach(addressOrName: string): this
  deployed(): Promise<this>

  interface: TimestampAfterEnforcerInterface
