...
import type { CanDelegate, CanDelegateInterface } from '../CanDelegate'
...
export class CanDelegate__factory {
  static readonly abi = _abi
  static createInterface(): CanDelegateInterface {
    return new utils.Interface(_abi) as CanDelegateInterface
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider,
  ): CanDelegate {
    return new Contract(address, _abi, signerOrProvider) as CanDelegate
  }
}
