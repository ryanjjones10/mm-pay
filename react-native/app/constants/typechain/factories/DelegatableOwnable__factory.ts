...
import type {
  DelegatableOwnable,
  DelegatableOwnableInterface,
} from '../DelegatableOwnable'
...
export class DelegatableOwnable__factory {
  static readonly abi = _abi
  static createInterface(): DelegatableOwnableInterface {
    return new utils.Interface(_abi) as DelegatableOwnableInterface
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider,
  ): DelegatableOwnable {
    return new Contract(address, _abi, signerOrProvider) as DelegatableOwnable
  }
}
