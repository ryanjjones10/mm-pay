...
import type { Delegatable, DelegatableInterface } from '../Delegatable'
...
export class Delegatable__factory {
  static readonly abi = _abi
  static createInterface(): DelegatableInterface {
    return new utils.Interface(_abi) as DelegatableInterface
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider,
  ): Delegatable {
    return new Contract(address, _abi, signerOrProvider) as Delegatable
  }
}
