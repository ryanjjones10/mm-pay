...
import type {
  DelegatableRelayCore,
  DelegatableRelayCoreInterface,
} from '../DelegatableRelayCore'
...
export class DelegatableRelayCore__factory {
  static readonly abi = _abi
  static createInterface(): DelegatableRelayCoreInterface {
    return new utils.Interface(_abi) as DelegatableRelayCoreInterface
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider,
  ): DelegatableRelayCore {
    return new Contract(address, _abi, signerOrProvider) as DelegatableRelayCore
  }
}
