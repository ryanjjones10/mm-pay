...
export interface BlockNumberEnforcerInterface extends utils.Interface {
  contractName: 'BlockNumberEnforcer'
  functions: {
...
export interface BlockNumberEnforcer extends BaseContract {
  contractName: 'BlockNumberEnforcer'
  connect(signerOrProvider: Signer | Provider | string): this
  attach(addressOrName: string): this
  deployed(): Promise<this>

  interface: BlockNumberEnforcerInterface
