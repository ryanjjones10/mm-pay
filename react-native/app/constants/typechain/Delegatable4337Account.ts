...
export interface Delegatable4337AccountInterface extends utils.Interface {
  ...
  functions: {
    ...
    'getDelegatorHash(address,uint256,bytes,(uint256,uint256))': FunctionFragment
  ...
  encodeFunctionData(
    functionFragment: 'getDelegatorHash',
    values: [string, BigNumberish, BytesLike, ReplayProtectionStruct],
  ): string
