...
export interface BlockNumberBeforeEnforcerInterface extends utils.Interface {
  contractName: 'BlockNumberBeforeEnforcer'
  functions: {
...
export interface BlockNumberBeforeEnforcer extends BaseContract {
  contractName: 'BlockNumberBeforeEnforcer'
  connect(signerOrProvider: Signer | Provider | string): this
  attach(addressOrName: string): this
  deployed(): Promise<this>

  interface: BlockNumberBeforeEnforcerInterface
