...
export interface MockDelegatableInterface extends utils.Interface {
  contractName: 'MockDelegatable'
  functions: {
    'alwaysFail()': FunctionFragment
  ...
  encodeFunctionData(functionFragment: 'alwaysFail', values?: undefined): string
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: 'alwaysFail', data: BytesLike): Result
...
export interface MockDelegatable extends BaseContract {
  contractName: 'MockDelegatable'
  connect(signerOrProvider: Signer | Provider | string): this
  attach(addressOrName: string): this
  deployed(): Promise<this>

  interface: MockDelegatableInterface
  ...
  functions: {
    alwaysFail(overrides?: CallOverrides): Promise<[void]>
  ...
  estimateGas: {
    alwaysFail(overrides?: CallOverrides): Promise<BigNumber>
  ...
  populateTransaction: {
    alwaysFail(overrides?: CallOverrides): Promise<PopulatedTransaction>
